...
import type { Component, Focusable, TerminalFocusAware } from "./tui.ts";
...
export class AltScreenSearchComponent implements Component, Focusable, TerminalFocusAware {
	...
	set terminalFocused(value: boolean) {
		this._terminalFocused = value;
		this.input.terminalFocused = value;
	}
